...
project = u'Invenio'
copyright = u'2013, 2014, 2015 CERN'
...
# [howto/manual]).
latex_documents = [
    ('index', 'Invenio.tex', u'Invenio Documentation', u'CERN', 'manual'),
]
...
man_pages = [
    ('index', 'invenio', u'Invenio Documentation',
     [u'CERN'], 1)
]
...
texinfo_documents = [
    ('index', 'Invenio', u'Invenio Documentation', u'CERN', 'Invenio',
