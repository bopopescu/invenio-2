...
from invenio.config import CFG_LOGDIR, CFG_PATH_MYSQL, CFG_PATH_GZIP, \
                            ...
                            CFG_DATABASE_PORT, \
                            CFG_DATABASE_SLAVE
from invenio.legacy.dbquery import get_connection_for_dump_on_subordinate, run_sql
...
""" % CFG_LOGDIR,
              specific_params=("n:o:p:S:",
                               ["number=", "output=", "params=", "subordinate=",
                                "compress", 'ignore-tables=',
                                "dump-on-subordinate-helper", "disable-workers"]),
